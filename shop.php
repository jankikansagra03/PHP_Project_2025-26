...
document.addEventListener('click', function(e) {
    ...
    if (cartBtn) {
        ...
        $.post('cart_handler.php', {action:'add', product_id:pid, quantity:1}, function(data) {
            ...
            showShopToast(data.message, data.success);
            if (data.success) {
        ...
        }, 'json').fail(function() { cartBtn.disabled=false; showShopToast('Error. Try again.', false); });
        return;
    }
    // ── Wishlist Toggle ──────────────────────────────────
    ...
    if (wlBtn) {
        ...
        }, 'json').fail(function() { wlBtn.disabled=false; showShopToast('Error. Try again.', false); });
    }
});
</script>
SHOPJS;
