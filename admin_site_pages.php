                                    ...
                                    <div class="modal-content">
                                        <form method="post" novalidate>
                                            ...
                                            <div class="modal-body modal-body-scroll"><input type="hidden" name="action" value="update"><input type="hidden" name="id" value="<?= (int) $row['id'] ?>"><input type="hidden" name="current_slug" value="<?= htmlspecialchars($slugFilter, ENT_QUOTES, 'UTF-8') ?>">
                                                <div class="mb-2"><label class="form-label">Slug</label><input type="text" class="form-control" name="page_slug" value="<?= htmlspecialchars((string) ($row['page_slug'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" required></div>
                                                <div class="mb-2"><label class="form-label">Title</label><input type="text" class="form-control" name="page_title" value="<?= htmlspecialchars((string) ($row['page_title'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" required></div>
                                                <div class="mb-2"><label class="form-label">Content</label><textarea class="form-control" name="page_content" rows="10" required><?= htmlspecialchars((string) ($row['page_content'] ?? ''), ENT_QUOTES, 'UTF-8') ?></textarea></div>
        ...
        <div class="modal-content">
            <form method="post" novalidate>
                ...
                <div class="modal-body modal-body-scroll"><input type="hidden" name="action" value="create"><input type="hidden" name="current_slug" value="<?= htmlspecialchars($slugFilter, ENT_QUOTES, 'UTF-8') ?>">
                    <div class="mb-2"><label class="form-label">Slug</label><input type="text" class="form-control" name="page_slug" required></div>
                    <div class="mb-2"><label class="form-label">Title</label><input type="text" class="form-control" name="page_title" required></div>
                    <div class="mb-2"><label class="form-label">Content</label><textarea class="form-control" name="page_content" rows="10" required></textarea></div>
                    <div class="mb-2"><label class="form-label">Status</label><select class="form-select" name="status">
